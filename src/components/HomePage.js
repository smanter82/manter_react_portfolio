          ...
          <Card style={{ width: "30rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                change. I have always enjoyed working with computers. I am
                taking a coding course through UNH, and now I look forward to
                using that passion in the world of Web Design.
              </Card.Text>
          ...
          <Card style={{ width: "30rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                time and energy, they have been super supportive of my quest to
                dive into Web Development. They stay out of my hair as much as
                they can while I'm doing homework, and my daughter even
                practices learning to code on her own computer next to me while
                I study.
              </Card.Text>
              <Button variant="primary">Go somewhere</Button>
            </Card.Body>
