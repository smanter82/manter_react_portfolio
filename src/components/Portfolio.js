    ...
    <>
      <Card style={{ width: "18rem" }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            ...
            log in with existing accounts, see trainer information, and view and
            join classes. It also allows trainers to add or remove their own
            classes. Managers on this app are able to view a list of trainers
            employed by the gym, pull up an individual trainer's information,
            terminate a trainer's employment by removing that trainer from the
            database, or hire a new trainer by adding his/her information into
            the database. A manager can also view all classes available at the
            gym for the week, view class rosters, and add/remove members from
            class rosters..
          </Card.Text>
        </Card.Body>
        <Card.Body>
      ...
      <Card style={{ width: "18rem" }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            ...
            will be able to write, save, and delete notes. They will be able to
            come back and view previously created notes.
          </Card.Text>
        </Card.Body>
        <Card.Body>
      ...
      <Card style={{ width: "18rem" }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            This app allows users to see the weather outlook for multiple cities
            and plan a trip accordingly. When searching for a city, the user is
            presented with current and future conditions for that city and that
            city is added to the search history. The user can also go back and
            view the weather for previously searched cities.
          </Card.Text>
        </Card.Body>
        <Card.Body>
